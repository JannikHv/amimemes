...
case "${1}" in
    ...
    okayletsgo)
        kill_audio
        curl -X POST https://memes.amicaldo.net/play/okayletsgo &> /dev/null &
        play_audio /var/amimemes/okay_lets_go.mp3
        ;;

    whatthefuck)
        kill_audio
        curl -X POST https://memes.amicaldo.net/play/whatthefuck &> /dev/null &
